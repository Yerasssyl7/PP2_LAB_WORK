...
def draw_grid_chess():
    ...
    # draw borders
    pygame.draw.rect(screen, BORDER_COLOR, (0, 0, WIDTH, CELL))  # top
    pygame.draw.rect(screen, BORDER_COLOR, (0, HEIGHT - CELL, WIDTH, CELL))  # bottom
    pygame.draw.rect(screen, BORDER_COLOR, (0, 0, CELL, HEIGHT))  # left
    pygame.draw.rect(screen, BORDER_COLOR, (WIDTH - CELL, 0, CELL, HEIGHT))  # right
